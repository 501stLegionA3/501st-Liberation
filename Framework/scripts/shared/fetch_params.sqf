...
/* Not saveable params */
GRLIB_param_wipe_savegame_1 = ["WipeSave1", 1] call bis_fnc_getParamValue;
GRLIB_param_wipe_savegame_2 = ["WipeSave2", 1] call bis_fnc_getParamValue;
...
KP_liberation_savegame_debug = ["DebugSave", 1] call bis_fnc_getParamValue;
