...
KP_liberation_supply_crate =   "plp_cts_MetalBarrelOlive";                     // This defines the supply crates, as in resources.
KP_liberation_ammo_crate =  "plp_cts_MetalBarrelRed";                     // This defines the ammunition crates.
KP_liberation_fuel_crate = "plp_cts_MetalBarrelYellow";                     // This defines the fuel crates.
