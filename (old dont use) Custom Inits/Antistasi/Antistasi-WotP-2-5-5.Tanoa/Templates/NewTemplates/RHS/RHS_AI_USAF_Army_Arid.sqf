...
_militiaLoadoutData setVariable ["backpacks", ["rhsusf_assault_eagleaiii_coy", "B_Kitbag_cbr", "B_AssaultPack_cbr"]];
_militiaLoadoutData setVariable ["atBackpacks", ["B_Carryall_cbr"]];
_militiaLoadoutData setVariable ["helmets", ["rhs_8point_marpatd", "H_Bandanna_cbr","rhsusf_lwh_helmet_marpatd"]];
_militiaLoadoutData setVariable ["sniHats", ["rhs_booniehat2_marpatd"]];
