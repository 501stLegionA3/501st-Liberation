...
_loadoutData setVariable ["sniHats", ["H_Booniehat_khk"]];
...
_sfLoadoutData setVariable ["uniforms", ["U_O_SpecopsUniform_ocamo"]];
_sfLoadoutData setVariable ["vests", ["V_HarnessO_brn"]];
_sfLoadoutData setVariable ["glVests", ["V_HarnessOGL_brn"]];
_sfLoadoutData setVariable ["Hvests", ["V_TacVest_brn"]];
_sfLoadoutData setVariable ["backpacks", ["B_TacticalPack_ocamo", "B_Carryall_ocamo", "B_FieldPack_ocamo", "B_Carryall_cbr", "B_Kitbag_cbr"]];
_sfLoadoutData setVariable ["helmets", ["H_HelmetSpecO_ocamo"]];
...
_militaryLoadoutData setVariable ["slUniforms", ["U_O_OfficerUniform_ocamo"]];
...
_militiaLoadoutData setVariable ["slUniforms", ["U_O_OfficerUniform_ocamo"]];
