...
switch (KP_liberation_preset_blufor) do {
    ...
    case 31: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\501st_preset.sqf";};
...
switch (KP_liberation_preset_opfor) do {
    ...
    case 21: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\501st_preset.sqf";};
...
switch (KP_liberation_preset_resistance) do {
    ...
    case  9: {[] call compileFinal preprocessFileLineNumbers "presets\resistance\501st_preset.sqf";};
...
switch (KP_liberation_preset_civilians) do {
    ...
    case  8: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\501st_preset.sqf";};
